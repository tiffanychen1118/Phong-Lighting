...
int main(void)
{
    ...
    {
        unsigned int vertexShaderID = CreateShader(ShaderType::VERTEX, "resource/shaders/BasicVS.vert");
        unsigned int fragShaderID = CreateShader(ShaderType::FRAGMENT, "resource/shaders/BasicPS.frag");
    ...
    {
        unsigned int vertexShaderID = CreateShader(ShaderType::VERTEX, "resource/shaders/BasicVS.vert");
        unsigned int fragShaderID = CreateShader(ShaderType::FRAGMENT, "resource/shaders/LightPS.frag");
